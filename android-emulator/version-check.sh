...
emulator -verbose -show-kernel -avd android-emulator-${EMULATOR_SDK_VERSION} -no-accel -no-audio -no-window -no-boot-anim -gpu swiftshader_indirect -memory 2048 -skin 480x800 &
